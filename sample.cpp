...
Display( )
{
	...
	//tree
	glPushMatrix();
	SetMaterial(0.6, 0.95, 0.4, shine);
	glScalef(0.1, 0.12, 0.1);
	glColor3f(0.6, 0.95, 0.4);
	...
	//floor
	glPushMatrix();
	SetMaterial(0.4, 0.36, 0.36, shine);
	glColor3f(0.4, 0.36, 0.36);
	glScalef(5., 1., 4.);
	...
	SetMaterial(0., 0.5, 0.5, shine);
	glTranslatef(-4. + t_X, 0., 1.5);
	...
	//butterfly 
	glPushMatrix();
	SetMaterial(0.5, 0.2, 0.95, shine);
	glRotatef(360 * Time, 0., 1., 0.);
	glTranslatef(0., 0.5 + 0.2 * sinf(9. * 3.1415926 * Time), 1.);
	glRotatef(90, 0., 1., 0.);
	glScalef(0.1, 0.1, 0.1);
	...
	//light 1
	glPushMatrix();
	SetMaterial(1., 1., 1., shine);
	glTranslatef(2., 5., 0.);
	glScalef(5., 5., 5.);
	glCallList(BoxList + 5);
	SetPointLight(GL_LIGHT1, 0., 0., 0.1, 1., 1., 1.);
	if (light_1 == 0)
	{
		glDisable(GL_LIGHT1);
	}
	...
	//light 2
	glPushMatrix();
	SetMaterial(1., 1., 0.2, shine);
	glTranslatef(-2.5, 2., 0.);
	glCallList(BoxList + 5);
	SetPointLight(GL_LIGHT0, 0., 0., 0.1, 1., 1., 0.2);
	if (light_2 == 0)
	{
		glDisable(GL_LIGHT0);
	}
	...
	//light 3
	glPushMatrix();
	SetMaterial(1., 0., 0., shine);
	glTranslatef(0.4, 0.04, 0.8);
	glCallList(BoxList + 5);
	SetSpotLight(GL_LIGHT2, 0., 0., 0.,		-1., 0., -1.,		1., 0., 0.);
	if (light_3 == 0)
	{
		glDisable(GL_LIGHT2);
	}
	...
	//light 4
	glPushMatrix();
	SetMaterial(0., 0., 1., shine);
	glTranslatef(-4. + t_X, 0.1, 1.5);
	glRotatef(360 * Time, 0., 1., 0.);
	glCallList(BoxList + 5);
	SetSpotLight(GL_LIGHT3, 0., 0.4, 0.,		1., 0., 0.,		0., 0., 1.);
	if (light_4 == 0)
	{
		glDisable(GL_LIGHT3);
	}
	...
	glTranslatef(0., 0.5 + 0.2 * sinf( 9. * 3.1415926 * Time), 1.);
	glCallList(BoxList + 5);
	SetPointLight(GL_LIGHT4, 0., 0.1, 0.,	0.5, 0.2, 0.95);
	if (light_5 == 0)
	{
		glDisable(GL_LIGHT4);
	}
...
InitGraphics( )
{
	...
	glClearColor( 0., 0., 0.1, BACKCOLOR[3] );
...
InitLists( )
{
	...
	LoadObjFile("./obj/cat.obj");
	glEndList( );

	glNewList(BoxList + 1, GL_COMPILE);
	LoadObjFile("./obj/tree.obj");
	glEndList();
	...
	LoadObjFile("./obj/lamp.obj");
	glEndList();

	glNewList(BoxList + 4, GL_COMPILE);
	LoadObjFile("./obj/flashlight.obj");
	glEndList();
	// create the axes:

	glNewList(BoxList + 5, GL_COMPILE);
	OsuSphere(0.02, 10, 10);
	glEndList();

	glNewList(BoxList + 6, GL_COMPILE);
	LoadObjFile("./obj/turtle.obj");
	glEndList();

	glNewList(BoxList + 7, GL_COMPILE);
	LoadObjFile("./obj/butterfly.obj");
	glEndList();
